...
public class PythagoreanTripletTest {
    @Test
public void tripletsWhoseSumIs12c() {
    ...
    List<PythagoreanTriplet> expected
        ...
        assertThat(actual.get(0).a).isEqualTo(expected.get(0).a);
        assertThat(actual.get(0).b).isEqualTo(expected.get(0).b);
        assertThat(actual.get(0).c).isEqualTo(expected.get(0).c);
}
